...
export class UnitKerjaRepository extends BaseRepository<
  Model<UnitKerjaAttributes>
> {
  constructor() {
    super(db.UnitKerja);
  }
   ...
   * @returns All data.
   */
  async findAll(req: Request): Promise<Model<UnitKerjaAttributes>[]> {
    try {
  ...
  async where(
    req: Request,
    criteria: WhereOptions<UnitKerjaAttributes>,
  ...
  async whereExisting(
    req: Request,
    criteria: Partial<UnitKerjaAttributes>,
  ): Promise<boolean> {
  ...
  async create(
    req: Request,
    entity: CreationAttributes<Model<UnitKerjaAttributes>>,
  ): Promise<Model<UnitKerjaAttributes> | string> {
  ...
  async bulkCreate(
    req: Request,
    entities: CreationAttributes<Model<UnitKerjaAttributes>>[],
  ): Promise<Model<UnitKerjaAttributes>[] | string> {
