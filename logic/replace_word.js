...
function replaceAllWords(str, kataYangDiubah, kataBaru) {
  return str.replaceAll(kataYangDiubah, kataBaru);
}

console.log(replaceAllWords(text, 'apabila', 'bila apa'))
console.log(replaceAllWords(text, 'ada', 'nggak ada'))